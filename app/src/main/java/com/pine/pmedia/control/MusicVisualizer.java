...
public class MusicVisualizer extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.md_yellow_700));

        canvas.drawRect(getDimensionInPixel(0), getHeight() - (20 + random.nextInt((int) (getHeight() / 1.5f) - 19)), getDimensionInPixel(4), getHeight(), paint);
        canvas.drawRect(getDimensionInPixel(7), getHeight() - (20 + random.nextInt((int) (getHeight() / 1.5f) - 19)), getDimensionInPixel(11), getHeight(), paint);
        canvas.drawRect(getDimensionInPixel(14), getHeight() - (20 + random.nextInt((int) (getHeight() / 1.5f) - 19)), getDimensionInPixel(18), getHeight(), paint);
    }
